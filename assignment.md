...
## Procedure and Instructional Video

## Steps to Identify and Report a Phishing Email at NC State

**Target Audience:** New NC State Students

**Purpose:** Help students identify phishing emails and common phishing indicators to report them safely.

**Tasks:**
1. Identify examples of potential phishing emails and how to pinpoint them.
2. Report suspicious phishing emails using Gmail's "Report Phishing" feature.
...
So, they must follow two main procedures to avoid a phishing scam:

1. Identify common warning signs in the fraudulent emails containing malicious links.
2. Report the email without clicking suspicious links or replying to the sender.
